...
Start with `00_PLAN/INSITE_Master_Plan.pdf` (the contract for the build) and `02_PROGRAM/INS-000_INSITE_Primer.pdf` (the plain-language education). The flagship is `02_PROGRAM/INS-002_Program_Whitepaper.pdf`. The evidence discipline lives in `01_EVIDENCE/Claims_Register.md`. The honest self-attack is `08_REDTEAM/Kill_Memo.pdf`. Open questions for the founder are consolidated in `07_BUILDLOG/Build_Log.pdf`, Part 1.
