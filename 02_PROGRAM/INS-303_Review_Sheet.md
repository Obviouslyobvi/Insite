...
**"You're missing that the investment is tax exempt."** Done. Investor Guide gains section 1.4, "Tax status of the interest": the notes are intended to be issued as tax-exempt obligations, federal and California, the customary pattern for California CFD financings, with bond counsel's opinion at closing making the exemption effective. The Capital Partner Brief carries the matching bullet.
