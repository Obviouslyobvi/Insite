...
**City, County, Joint Powers Authority. Draft version 0.99, July 13, 2026, prepared for the founder's review. This full draft builds out the founder's outline of July 11 and 12. Both open program decisions were answered on July 13. School fees (question 9): excluded at launch, definitely, while the founder researches whether the reimbursement structure avoids the joint agreement; the mechanics stay documented in Chapters 2.5 and 6.5 as the future path. The financing platform (question 10): each project's annexation carries its own note; the warehouse line and the credit facility are one instrument; and that facility funds every origination until the optional bond take-out at portfolio stabilization. The outline's mechanical defects are corrected here per the comparison memo; every factual claim traces to the INSITE Claims Register, entries listed in the Sources section; and the appendices carry full sample instruments and rendered diagrams, every sample bannered on its face for bond counsel review and marked not for execution. The founder's Google Doc remains the source of truth until he adopts this draft.**
...
**2.3 Eligible development projects.** Residential subdivisions of 1 to 50 lots within a participating jurisdiction; finished or near-finished lots; financing capped at 25 percent of appraised value, program policy stricter than the statute's three-to-one floor in Government Code 53345.8; and a minimum financing size set at feasibility screening (the statewide pool's own floor is $500,000 per agency; the founder sets INSITE's at screening).
...
**2.5 Eligible development fees.** Development impact fees levied by the participating agency are the program's core. School fees are excluded at launch, decided July 13, while the founder researches the reimbursement reading. If the decision is ever reopened, the mechanism is a thin master joint community facilities agreement per city-and-district pair under Government Code 53316.2, with the developer paying the fee, presenting the district's clearance certificate, and receiving reimbursement from proceeds, subject to two bond counsel confirmations recorded in the Build Log. Utility connection fees, capacity charges, capitalized interest, and reserves appear in the founder's outline and enter the program only after counsel confirms each category.
...
**3.3 School districts.** School fees are excluded at launch (decided July 13), so districts are unaffected by the program; developers pay school fees exactly as they do today. If the founder's continuing research ever reopens the question, the pay-then-reimburse path in Chapter 2.5 is the documented route, and it costs a district one master agreement signature.
...
**6.5 Eligible financing costs.** The core is the participating agency's own development impact fees, plus the formation and financing costs the Act allows. School fees are excluded at launch (decided July 13); the joint-agreement mechanism and the pay-then-reimburse mechanics stay documented in Chapter 2.5 as the path if the founder's research ever reopens them. The outline's further categories, utility connection fees, capacity charges, public improvements, capitalized interest, and reserves, are listed for the founder's scope decision and enter only with bond counsel's confirmation per category.

**6.6 The INSITE financing platform.** Confirmed July 13: one pipeline at three altitudes. At origination, each project's funding is a privately placed, tax-secured obligation sized to that project alone, secured only by that project's special taxes, with no cross-collateralization. A revolving warehouse credit facility carries the growing portfolio: draw request, funding approval, advance, payment of eligible costs, repayment through the annual special taxes. And pooled tax-exempt bonds stand as the optional permanent take-out once the portfolio stabilizes. The advantages the founder's outline claims for this platform are real and specific: immediate access to capital rather than waiting on a bond sale, funding for projects too small to carry their own bond issue, and continuous financing as annexations continue.
...
**8.5 INSITE.** A standing district in each participating jurisdiction rather than a statewide pool; the agency's own council keeping every approval; underwriting and documents standardized for 1 to 50 lots; and funding mechanics that do not wait for a bond sale.
...
| Built for | Master-planned scale | Improvements | Fees and improvements; pool typically 50 to 250 units | Fees and improvements | 1-to-50-lot subdivisions |
| Local approval of each project | Yes | Yes | Through the pool | Through the pool | Yes, the council |
| Funding timing | Bond sale | Bond sale | Pooled bond cycles | Bond cycles | Advance at approval from the warehouse facility |
...
**10.2 Financing.** What are the rates? Set at term sheet, not in marketing; every figure in circulation is a target. What protects the security? Debt capped at 25 percent of appraised value by independent MAI appraisal to State Treasurer standards, against the statute's three-to-one floor. Can an owner exit? Yes; the prepayment right rests on Government Code 53344 and is defined in the recorded rate-and-method.
...
**10.4 Developer.** Where do developers start? The companion INS-302 Developer Guide and the INS-201 data package. What does a developer pay? The deal's execution costs, targeted at $5,000 to $30,000 per project, a founder estimate pending vendor quotes, plus program fees set at term sheet. Are school fees included? No; excluded at launch by the founder's July 13 decision. Developers pay school fees directly, as today.
...
**B-5, facility cash flow.** Draw, approve, advance, pay eligible costs, and the special taxes repay the revolving facility.
...
| Appraisal (25 percent debt-to-value policy) | | | Engages and manages panel | Independent MAI appraiser |
...
**Joint Community Facilities Agreement.** Purpose: required by Government Code 53316.2 whenever another agency's facilities or fees are financed; on the school path, the thin master form per city-and-district pair. Key terms: the financed fees, requisition mechanics on the Riverside pattern, no obligations beyond receipt. Trigger: only if school fees are ever added after the founder's research. TO BE DRAFTED BY BOND COUNSEL.
...
**G-4, bond counsel.** - [ ] The Appendix D suite drafted from the term descriptions - [ ] The Appendix A and E samples reviewed and revised for execution - [ ] Only if school fees are ever reopened: the joint agreement confirmed for fee reimbursement, and the look-back window confirmed - [ ] Formation and annexation forms conformed to the agency's practice
