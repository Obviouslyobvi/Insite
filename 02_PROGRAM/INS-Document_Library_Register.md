...
| INS-301 | Participating Public Agency Guide (City, County, JPA) | Full draft v0.9 built July 13 from the founder's outline: all ten chapters, appendices as counsel term maps, the two decisions marked in place (questions 9 and 10), defects corrected, 28 claim families crosswalked to the register (07_BUILDLOG/INS-301_Draft_Claims_Crosswalk), page-by-page visual verification passed | Founder merges or edits the draft; his two answers unlock final |
